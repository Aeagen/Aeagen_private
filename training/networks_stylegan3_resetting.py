...
class MappingNetwork(torch.nn.Module):
    def __init__(self,
        ...
        # additions
        embed_path = "E://医学图像数据集//styleGAN-xl//stylegan-xl-main//in_embeddings//tf_efficientnet_lite0.pkl"
        ...
        # Construct layers.
        self.embed_proj = FullyConnectedLayer(self.embed.embedding_dim, self.z_dim,
...
class SynthesisLayer(torch.nn.Module):
    def __init__(self,
        ...
        self.init_upfirdn(in_sampling_rate, out_sampling_rate, in_cutoff, out_cutoff,
                          in_half_width, out_half_width, in_size, out_size, self.up_taps)

    def init_upfirdn(self, in_sampling_rate, out_sampling_rate, in_cutoff, out_cutoff,
                     in_half_width, out_half_width, in_size, out_size, up_taps, filt_suff=''):
        # reset values
        self.in_sampling_rate = in_sampling_rate
        self.out_sampling_rate = out_sampling_rate
...
class SynthesisNetwork(torch.nn.Module):
    def __init__(self,
        ...
        sizes = [36, 36, 36, 36, 36, 36, 52, 52, 84, 84, 64, 64]
        up_taps = [12, 12, 12, 12, 12, 12, 24, 12, 24, 12, 12, 1]
        half_widths = [6, 5.36098, 4.1578, 3.40521, 2.27686, 2.27686, 6.15084, 6.15084, 14.2469, 7.39662, 7.39662, 7.39662]
        cutoffs = [2, 2.63902, 3.4822, 4.59479, 6.06287, 6.06287, 9.84916, 9.84916, 17.7531, 32, 32, 32]
        ...
        for idx in range(self.num_layers + 1):
            ...
            layer = SynthesisLayer(
                ...
                **layer_kwargs)
            if idx > 4 :
                name = f'L{idx+1}_{layer.out_size[0]}_{layer.out_channels}'
            else:
